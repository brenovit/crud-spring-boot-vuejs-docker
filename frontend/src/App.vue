  ...
  <div id="app">
    <nav class="navbar navbar-expand navbar-dark bg-dark">
      ...
      <div class="navbar-nav mr-auto">
        ...
        <li class="nav-item">
          <a href="/products" class="nav-link" v-if="currentUser">Product</a>
        </li>
      </div>
...
export default {
  computed: {
    ...
    showAdminBoard() {
      if (this.currentUser) {
        return this.currentUser.roles.includes("ROLES_ADMIN");
      }
    ...
    showModeratorBoard() {
      if (this.currentUser) {
        return this.currentUser.roles.includes("ROLES_MODERATOR");
      }
